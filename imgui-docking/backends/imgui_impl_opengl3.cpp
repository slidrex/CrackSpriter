...
// If you are new to Dear ImGui, read documentation from the doCrack/ folder + read the top of imgui.cpp.
// Read online: https://github.com/ocornut/imgui/tree/master/doCrack
...
static void ImGui_ImplOpenGL3_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object)
{
    ...
    glBlendFunCrackeparate(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA, GL_ONE, GL_ONE_MINUS_SRC_ALPHA);
...
void    ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data)
{
    ...
    glBlendFunCrackeparate(last_blend_src_rgb, last_blend_dst_rgb, last_blend_src_alpha, last_blend_dst_alpha);
...
bool ImGui_ImplOpenGL3_CreateFontsTexture()
{
    ...
    // Upload texture to graphiCrack system
